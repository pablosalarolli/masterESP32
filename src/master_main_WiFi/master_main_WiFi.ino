...
*/
#include "gainProtocolWiFiMaster.h"
...
const char* ssid     = "ESP32-COM_DADOS_AP";
const char* password = "123456789";
byte checksum = 0, cabecalho = 0, addr = 0, opcode = 0, dadoA = 0, dadoB = 0, opcode_slave = 0;
byte buff[4];
int dado = 0, flag = 0, i = 0;
    ...
    while (client.connected()) {
      ...
      switch (estado) {
        ...
        case RECEBE_MSG_PC:
          ...
          i = 0;
          while (client.available() > 0) { //Enquanto houver transmissão de dados:
            if (i < 4) {                    //se nº bytes recebidos<4:
              buff[i] = client.read();     //retira o byte recebido mais antigo e o transfere para um buffer interno
